...
<div class="form-row">
    <div class="offset-0 offset-md-3 col-12 col-md-9">
        <button type="submit" class="btn btn-success">@lang('products-catalog/family.save')</button>
        <a href="{{ route('backend.families') }}" class="btn btn-danger">@lang('products-catalog/family.cancel')</a>
    </div>
</div>
