...
<div class="form-row form-group">
    <label class="col-12 col-md-3 control-label mt-2 mb-0">@lang('Description')</label>
    <div class="col-6">
...
<div class="form-row form-group align-items-center">
    ...
    <div class="col-3">
        <input name="weight" type="number" min="0" step="0.01"
            ...
            placeholder="(@lang('optional')) @lang('products-catalog/product.weight.0')">
    </div>
</div>
        ...
        <div class="form-row">
            <div class="col-4">
                <input name="length" type="number" min="0" step="0.01"
                    ...
                    placeholder="(@lang('optional')) @lang('products-catalog/product.length.0')">
            </div>
            <div class="col-4">
                <input name="width" type="number" min="0" step="0.01"
                    ...
                    placeholder="(@lang('optional')) @lang('products-catalog/product.width.0')">
            </div>
            <div class="col-4">
                <input name="height" type="number" min="0" step="0.01"
                    ...
                    placeholder="(@lang('optional')) @lang('products-catalog/product.height.0')">
            </div>
        </div>
    </div>
</div>
    ...
    <div class="col-3">
        <div class="form-check">
            ...
            <input type="checkbox" id="giftcard"
                ...
                class="form-check-input {{ $errors->has('giftcard') ? 'is-danger' : '' }}" placeholder="@lang('products-catalog/product.giftcard._')">
    ...
    <div class="col-6">
        <div class="input-group">
            ...
            <input name="url" type="text"
                ...
                placeholder="(@lang('optional')) @lang('products-catalog/product.url.0')">
        </div>
    </div>
</div>
    ...
    <div class="col-3">
        <div class="form-check">
            ...
            <input type="checkbox" id="visible"
                ...
                class="form-check-input {{ $errors->has('visible') ? 'is-danger' : '' }}" placeholder="@lang('products-catalog/product.visible._')">
...
<div class="form-row">
    <div class="offset-0 offset-md-3 col-12 col-md-9">
        <button type="submit" class="btn btn-success">@lang('products-catalog/product.save')</button>
        <a href="{{ route('backend.products') }}" class="btn btn-danger">@lang('products-catalog/product.cancel')</a>
    </div>
</div>
