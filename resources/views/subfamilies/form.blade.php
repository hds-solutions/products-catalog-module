...
<div class="form-row">
    <div class="offset-0 offset-md-3 col-12 col-md-9">
        <button type="submit" class="btn btn-success">@lang('products-catalog/subfamily.save')</button>
        <a href="{{ route('backend.subfamilies') }}" class="btn btn-danger">@lang('products-catalog/subfamily.cancel')</a>
    </div>
</div>
