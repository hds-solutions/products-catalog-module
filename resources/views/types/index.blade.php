...
@section('description', __('products-catalog/type.description'))
    ...
    <div class="card-header">
        <div class="row">
            <div class="col-6">
                ...
                @lang('products-catalog/type.index')
            </div>
            ...
            <div class="table-responsive">
                {{
                    $dataTable->table([
                        ...
                        'data-route'    => route('backend.types'),
            ...
            <div class="text-center m-t-30 m-b-30 p-b-10">
                ...
                <p class="text-muted">
                    ...
                    <a href="{{ route('backend.types.create') }}" class="text-custom">
                        <ins>@lang('products-catalog/type.add')</ins>
                    </a>
                </p>
            </div>
        @endif
