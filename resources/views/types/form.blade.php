...
<div class="form-row">
    <div class="offset-0 offset-md-3 col-12 col-md-9">
        <button type="submit" class="btn btn-success">@lang('products-catalog::types.save')</button>
        <a href="{{ route('backend.types') }}" class="btn btn-danger">@lang('products-catalog::types.cancel')</a>
    </div>
</div>
