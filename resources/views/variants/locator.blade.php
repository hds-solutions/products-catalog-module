<div class="form-row locator-container mb-3" @if ($selected === null) id="new" @else data-used="true" @endif>
    <div class="col-6">
        <select name="warehouses[]" @if (isset($selected)) id="f{{ $id = Str::random(16) }}" @endif
            ...
            class="form-control selectpicker" placeholder="@lang('Locator')">
            <option value="" selected disabled hidden>@lang('Locator')</option>
    ...
    <div class="col-4">
        <select name="locators[]"
            ...
            class="form-control custom-select" placeholder="@lang('Locator')">
            <option value="" selected disabled hidden>@lang('Locator')</option>
