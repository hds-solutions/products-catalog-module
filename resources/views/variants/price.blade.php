<div class="form-row price-container mb-3"
...
{{--
 ...
 --}}
        <x-form-foreign name="prices[currency_id][]" id="{{ isset($selected) ? 'f'.($id = Str::random(16)) : null }}"
            :values="$currencies"

            show="code name" title="code"
            append="decimals"
            default="{{ $old['currency_id'] ?? $selected?->id ?? null }}"
