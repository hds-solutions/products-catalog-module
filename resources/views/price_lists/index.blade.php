...
@section('description', __('products-catalog::price_lists.description'))
    ...
    <div class="card-header">
        <div class="row">
            <div class="col-6 d-flex align-items-center">
                ...
                @lang('products-catalog::price_lists.index')
            </div>
        ...
        @else
            <div class="text-center m-t-30 m-b-30 p-b-10">
                ...
                <p class="text-muted">
                    ...
                    <a href="{{ route('backend.price_lists.create') }}" class="text-custom">
                        <ins>@lang('products-catalog::price_lists.create')</ins>
                    </a>
                </p>
            </div>
        @endif
