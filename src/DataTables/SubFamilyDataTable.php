...
class SubFamilyDataTable extends DataTable {
    /**
    ...
    protected function getColumns() {
        return [
            Column::make('id')->title( __('products-catalog/subfamily.id.0') )->hidden(),
            Column::make('family')->data('family.name')->title( __('products-catalog/subfamily.family_id.0') ),
            Column::make('name')->title( __('products-catalog/subfamily.name.0') ),
            Column::make('actions'),
        ];
    }
